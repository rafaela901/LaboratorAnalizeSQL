...
;
insert into SERVICII values(5000,'Consultatie genetica',' proces de comunicare prin care specialistul genetician“sfãtuie?te pacien?ii ?i/sau rudele lor cu risc pentru o boalã
ce poate fi ereditarã în legãturã cu efectele bolii,
 probabilitatea apari?iei sau transmiterii ei în familie ?i cãile prin care aceasta poate fi prevenitã sau amelioratã”',110);
insert into SERVICII values(5001,'Determinarea factorului Rh','nu este necesarã o pregãtire prealabilã; sunt utile informaþii asupra unor tratamente perfuzabile cu soluþii macromoleculare
 efectuate premergãtor determinãrii, transfuzii în ultimele 120 zile',38);
insert into SERVICII values(5002,'ARN Viral SARS-CoV-2','Test diagnostic COVID-19 RT-PCR (Coronavirus) este disponibil toate centrele din ?arã ?i se poate efectua atât la cerere, cât ?i 
în baza unei programãri',185);
